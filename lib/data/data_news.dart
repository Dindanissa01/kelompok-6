...
List<News> newslist = [
  ...
  News(
      id: 12321,
      deskripsi:
          " Nam Tae Hyun telah dikirim ke kejaksaan terkait kasus mengendara sambil mabuk (DUI). Padahal mantan anggota WINNER (II) itu sedang dalam penyelidikan kasus narkoba.",
      gambar: "asset/namtaehyun.jpg",
      judul:
          "Setelah Ditangkap Polisi, Nam Tae Hyun Telah Diserahkan Pada Kejaksaan Usai Terlibat DUI. Bulan Lalu, Mantan Member WINNER Ini Menabrak Taksi Hingga Menimbulkan Kerusakaan Bagi Korban."),
  News(
      id: 12320,
      deskripsi:
          "Belum lama ini aktris veteran Kim Hee Ae tampil sebagai bintang tamu dalam acara hiburan tvN “You Quiz on the Block” yang ditayangkan pada tanggal 12 April kemarin. Dalam kesempatan tersebut bintang serial The World of the Married ini berbicara banyak hal termasuk soal masa mudanya yang dikenal dengan visualnya yang menawan.",
      gambar: "asset/kimtae.jpg",
      judul:
          "Kim Hee Ae Ungkap Visualnya Di Foto-Foto Masa Muda Yang Bikin Dirinya Debut"),
];
